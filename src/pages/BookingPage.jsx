...
function BookingHeader() {
  ...
  return <header ref={headerRef} className={`header${headerHidden ? ' header-hidden' : ''}`} data-section="01-header">
    <div className="nav-wrap">
      <Link to="/" className="brand" aria-label="Lions Plus — home"><span className="logo-crop"><img src="/brand/lions-plus-white.png" alt="Lions Plus" width="5404" height="3414" /></span></Link>
...
export default function BookingPage() {
  ...
  return <div className="portal-page">
    ...
    <main>
      <section className="booking-hero"><img className="booking-hero-photo" src="/portfolio/54001835913.jpg" alt="" aria-hidden="true" /><div className="booking-hero-shade" /><BookingWave id="booking-hero-wave" /><div className="portal-shell booking-hero-content"><p className="portal-eyebrow">Lions Plus Booking</p><h1>From request to <span>final delivery.</span></h1><p>Request creative production and technology services, receive a quotation, confirm your booking and follow the project through completion.</p><div className="portal-actions"><a className="portal-button primary" href="#request">Start a booking <FaArrowRight aria-hidden="true" /></a><a className="portal-button" href="#process">See how it works</a></div><p className="booking-rule">Submitting a request does not confirm a booking. Confirmation follows scope, resource, quotation, contract and deposit review.</p></div></section>
    ...
    <footer className="portal-footer portal-shell"><span>© 2026 Lions Plus</span><Link to="/"><FaArrowLeft aria-hidden="true" /> Main website</Link></footer>
  </div>
}
